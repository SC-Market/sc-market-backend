...
// This host serves only the JSON API and the sitemap files. Block only the API
// surface; everything else (notably the sitemaps, which are not under /api/)
// stays crawlable by default.
