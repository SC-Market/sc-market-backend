...
const MISSION_TYPE_MAP: Record<string, string> = {
  ...
  // Contract template names
  itemresourcegathering_generic: "Resource Gathering",
  itemresourcegathering_shipmining: "Ship Mining",
  itemresourcegathering_fpsmining: "Hand Mining",
  destroyitems: "Destroy Targets",
  destroyitems_2locations: "Destroy Targets",
  destroyitems_bombingrun_shipcombatencounter: "Bombing Run",
  killship: "Bounty Hunting",
  killship_nearlocation: "Bounty Hunting",
  bounty: "Bounty Hunting",
  bounty_nearlocation: "Bounty Hunting",
  shipheist: "Ship Heist",
  shipheistcounteroffer: "Ship Heist",
  eliminateall: "Eliminate All",
  eliminatespecific: "Eliminate Target",
  chaineliminateall_3locations: "Eliminate All (Chain)",
  chaineliminateall_3locations_eliminatespecific: "Eliminate Target (Chain)",
  chaineliminateall_1location_eliminatespecific: "Eliminate Target (Chain)",
  chaineliminateall_2locations_eliminatespecific: "Eliminate Target (Chain)",
  missingperson: "Missing Person",
  missingperson_cave: "Missing Person",
  missingperson_station: "Missing Person",
  recoveritem: "Recover Item",
  recoveritem_space: "Recover Item",
  recovercargo: "Recover Cargo",
  recovercargo_fps: "Recover Cargo",
  defendship: "Defend Ship",
  defendlocation: "Defend Location",
  defenddestructibleentities: "Defend Location",
  escortships: "Escort",
  shipwaveattack: "Ship Combat",
  shipambush: "Ship Ambush",
  patrol: "Patrol",
  salvage_lawful: "Salvage",
  salvage_unlawful: "Salvage",
  salvage_unlawful_withqt: "Salvage",
  salvage_coverup: "Salvage",
  killanimals: "Hunt Wildlife",
  killanimalsatlocation: "Hunt Wildlife",
  haulcargo_atob: "Cargo Hauling",
  haulcargo_singletomulti: "Cargo Hauling",
  haulcargo_multitosingle: "Cargo Hauling",
  delivery_single: "Delivery",
  delivery_multi: "Delivery",
  clearcrimestat: "Clear Crimestat",
  timetrial: "Time Trial",
  boardship: "Board Ship",
  antibombingrun: "Anti-Bombing Run",
  acepilot: "Ace Pilot",
  facilitydelve: "Facility Delve",
...
export class GameDataImportService {
  ...
  private async upsertMission(
    ...
    const missionRecord = {
      ...
      reputation_reward_faction: mission.reputationRewards?.[0]?.factionName || null,
      ...
      star_system: mission.starSystem || null,
      faction: mission.missionGiver || null,
